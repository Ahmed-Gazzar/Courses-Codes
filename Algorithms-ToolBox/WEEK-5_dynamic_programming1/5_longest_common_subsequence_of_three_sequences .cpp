...
vector<int> f2(vector<vector<int>> res, vector<int> a, vector<int> b) {
...
vector<int> lcs22(vector<int>& a, vector<int>& b) {
	int indel = 0, mismatch = 0;
	int l1 = a.size();
	int l2 = b.size();
	vector<vector<int>> res(l1 + 1, vector<int>(l2 + 1, 0));
...
int main() {
	...
	vector<int> ab = lcs22(a, b);
	std::cout << lcs2(c, ab) << std::endl;
